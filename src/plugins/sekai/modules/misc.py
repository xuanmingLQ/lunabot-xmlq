...
md_update_group_sub = SekaiGroupSubHelper("update", "MasterData更新通知", RegionAttributes.MASTERDATA)
ad_result_sub = SekaiUserSubHelper("ad", "广告奖励推送", RegionAttributes.AD_RESULT, hide=True)
